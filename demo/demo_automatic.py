...
if __name__ == '__main__':
    ...
    cfg['level'] = os.getenv("LEVEL",'default')
    print("level is ",cfg['level'])
    ...
    result_saver = ResultSaver(out_path, None, dataset='demo', object_manager=deva.object_manager,feature_level=cfg['level'])
